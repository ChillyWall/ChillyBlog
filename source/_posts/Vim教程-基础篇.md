...
Normal模式下，可以进行搜索，按`/`后可以开始输入搜索内容，输入完后按下回车执行，可以使用按键快速在搜索结果之间跳转。
...
要退出Insert模式回到Normal模式，只需要按下`Esc`即可。
...
到这里基础篇就已经介绍完毕。读完本篇你应该已经对vim有了大致的了解。
